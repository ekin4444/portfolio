...
export const home = [
  {
    text: "HELLO I'M",
    name: "Ekin Filiz Ataş",
    post: "UI / UX DEVELOPER",
    design: "WEB DEVELOPER",
    desc: "I'm Ekin Filiz Ataş, a recent graduate in Information Systems Engineering from Piri Reis University. My journey combines a deep passion for software development and UX/UI design with hands-on experience in web design and software testing. I've successfully crafted innovative solutions like a notable Brain Tumor Prediction Website using Python, Django, and machine learning. My proficiency in Turkish, English, and German empowers me to collaborate globally and contribute effectively to diverse projects.",
  },
]
export const about = [
  {
